...
Regulated dealers are required to keep records of the customer due diligence ("**CDD**") and enhanced customer due diligence ("**ECDD**") performed. The <a target="_blank" href="/files/Sample CDD and ECDD Form_20260512_v5_1.docx">sample forms</a> are extracted from the Guidelines and available in Microsoft Word document format for ease of editing. <br>
